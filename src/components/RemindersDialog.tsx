                  ...
                  >
                    <div className="space-y-1.5 min-w-0 flex-1">
                      ...
                      <div className="text-[10.5px] text-slate-400 font-medium">
                        {t.remindersAutomaticDeactivation.replace("{date}", formatCleanDate(m.endDate))}
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-1.5 flex-shrink-0">
                      ...
                      <button
                        onClick={() => {
                          ...
                          const cleanExpDate = formatCleanDate(m.endDate);
                          const msg = lang === "en" 
                            ? `Hello ${m.name}, this is Seahorse Fitness Inc. Your swimming membership pass (${normalizedPlan}) is set to expire on ${cleanExpDate}. To continue enjoying pool access, please stop by our counter or call us at 347-272-2822 to renew. Thank you!`
                            : `【海马游泳中心】尊贵的会员${m.name}，您的${normalizedPlan}即将于${cleanExpDate}到期，为了不影响您的日常入水及游泳体验，请您在空闲时间抽空前往柜台，或联系我们的客服（347-272-2822）办理续卡。祝您生活愉快！`;
